...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            CMD = New SqlCommand("SELECT Mas_Refno FROM MasMsg Where Mas_Flag='No'", CON)
            ...
            If count1 <> 0 Then
                ...
                For Each drt2 In DS.Tables("MasterDocs").Rows
                    ...
                    ADA1 = New SqlDataAdapter("SELECT * FROM MasMsg Where Mas_refno='" & Trim(LsRefno.SelectedValue) & "'", CON)
                    ...
                    If count1 <> 0 Then
                        ...
                        For Each drt3 In DS.Tables("MasMsg").Rows
                            Txtdes1.Text = Trim(drt3("Mas_Msg1"))
                            ' TxtAppDate.Text = Format(CDate(Trim(drt3("Mas_Appdt"))), "dd/MM/yyyy")
                            If Trim(drt3("Mas_Flag")) = "No" Then
                                TxtRecDate.Text = Format(CDate(Today()), "dd/MM/yyyy")
                            Else
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Dim Cmd As New SqlCommand("SELECT * FROM MasMsg", CON)
        Cmd.ExecuteNonQuery()

        ADA = New SqlDataAdapter("SELECT * FROM MasMsg Where Mas_RefNo='" & Trim(TxtRefno.Text) & "'", CON)
        DS = New DataSet
        ADA.Fill(DS, "MasMsg")
        ...
        If count1 <> 0 Then
            ...
            Cmd.CommandText = ("UPDATE MasMsg SET Mas_Msg1='" & Trim(Txtdes1.Text) & "',Mas_Recdt='" & Mid(Trim(TxtRecDate.Text), 4, 2) + "/" + Mid(Trim(TxtRecDate.Text), 1, 2) + "/" + Mid(Trim(TxtRecDate.Text), 7, 4) & "',Mas_flag='Yes' WHERE Mas_Refno='" & Trim(TxtRefno.Text) & "'")
            Cmd.ExecuteNonQuery()
        Else
            ...
            Cmd.CommandText = ("INSERT INTO MasMsg(Mas_Refno,Mas_Msg1,Mas_Recdt,Mas_Flag) VALUES ('" & Trim(TxtRefno.Text) & "','" & Trim(Txtdes1.Text) & "','" & Mid(Trim(TxtRecDate.Text), 4, 2) + "/" + Mid(Trim(TxtRecDate.Text), 1, 2) + "/" + Mid(Trim(TxtRecDate.Text), 7, 4) & "','Yes')")
            Cmd.ExecuteNonQuery()
            ss = Format(Today(), "MM/dd/yyyy")
            Cmd.CommandText = ("UPDATE MasterDocs SET Mas_flag4='Ok' WHERE Mas_Refno='" & Trim(TxtRefno.Text) & "'")
            Cmd.ExecuteNonQuery()
