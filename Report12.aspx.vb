...
Public Class Report12
    ...
    Protected WithEvents LsLC As System.Web.UI.WebControls.DropDownList
    Protected WithEvents LsBD As System.Web.UI.WebControls.DropDownList
    Protected WithEvents LsTT As System.Web.UI.WebControls.DropDownList
    Protected WithEvents LsNF As System.Web.UI.WebControls.DropDownList
    Protected WithEvents LSDA As System.Web.UI.WebControls.DropDownList
    Protected WithEvents lSDP As System.Web.UI.WebControls.DropDownList
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            CMD = New SqlCommand("SELECT Mas_IndNos FROM MasterDocs Where Mas_Intrm='LC' order by Mas_Cmpnycode,Mas_indNos", CON)
            ...
            DR.Close()
            CMD = New SqlCommand("SELECT Mas_IndNos FROM MasterDocs Where Mas_Intrm='BD' order by Mas_Cmpnycode,Mas_indNos", CON)
            'ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where Mas_RefNo='" & Trim(TxtRefno.Text) & "'", CON)
            DR = CMD.ExecuteReader
            ...
            DR.Close()
            CMD = New SqlCommand("SELECT Mas_IndNos FROM MasterDocs Where Mas_Intrm='DP' order by Mas_Cmpnycode,Mas_indNos", CON)
            'ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where Mas_RefNo='" & Trim(TxtRefno.Text) & "'", CON)
            DR = CMD.ExecuteReader
            ...
            CMD = New SqlCommand("SELECT Mas_IndNos FROM MasterDocs Where Mas_Intrm='TT' order by Mas_Cmpnycode,Mas_indNos", CON)
            'ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where Mas_RefNo='" & Trim(TxtRefno.Text) & "'", CON)
            DR = CMD.ExecuteReader
            ...
            DR.Close()
            CMD = New SqlCommand("SELECT Mas_IndNos FROM MasterDocs Where Mas_Intrm='NF' order by Mas_Cmpnycode,Mas_indNos", CON)
            'ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where Mas_RefNo='" & Trim(TxtRefno.Text) & "'", CON)
            DR = CMD.ExecuteReader
    ...
    Private Sub LsLC_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LsLC.SelectedIndexChanged
        count1 = Len(Trim(TxtIn.Text))
        ss = Trim(TxtIn.Text)

        'ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where substring(Mas_IndNos,1," & count1 & ")='" & Trim(TxtIn.Text) & "' AND Mas_flag3='Yes' and Mas_Entry1='Ok'", CON)
        ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where Mas_IndNos='" & Trim(LsLC.SelectedValue) & "'", CON)
        DS = New DataSet
        ADA.Fill(DS, "MasterDocs")
        ...
        'myExportFile = Server.MapPath(".") & "/Data/AAA.PDF"
        'myDiskFileDestinationOptions = New CrystalDecisions.Shared.DiskFileDestinationOptions
        'myDiskFileDestinationOptions.DiskFileName = myExportFile
        'myExportOptions = myReport.ExportOptions
        'With myExportOptions
        ...
        'Response.Redirect("Data/AAA.PDF")
    ...
    Private Sub lSDP_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lSDP.SelectedIndexChanged
        count1 = Len(Trim(TxtIn.Text))
        ss = Trim(TxtIn.Text)

        'ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where substring(Mas_IndNos,1," & count1 & ")='" & Trim(TxtIn.Text) & "' AND Mas_flag3='Yes' and Mas_Entry1='Ok'", CON)
        ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where Mas_IndNos='" & Trim(lSDP.SelectedValue) & "'", CON)
        DS = New DataSet
        ADA.Fill(DS, "MasterDocs")
    ...
    Private Sub LsBD_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LsBD.SelectedIndexChanged
        count1 = Len(Trim(TxtIn.Text))
        ss = Trim(TxtIn.Text)

        'ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where substring(Mas_IndNos,1," & count1 & ")='" & Trim(TxtIn.Text) & "' AND Mas_flag3='Yes' and Mas_Entry1='Ok'", CON)
        ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where Mas_IndNos='" & Trim(LsBD.SelectedValue) & "'", CON)
        DS = New DataSet
        ADA.Fill(DS, "MasterDocs")
    ...
    Private Sub LSDA_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LSDA.SelectedIndexChanged
        count1 = Len(Trim(TxtIn.Text))
        ss = Trim(TxtIn.Text)

        'ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where substring(Mas_IndNos,1," & count1 & ")='" & Trim(TxtIn.Text) & "' AND Mas_flag3='Yes' and Mas_Entry1='Ok'", CON)
        ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where Mas_IndNos='" & Trim(LSDA.SelectedValue) & "'", CON)
        DS = New DataSet
        ADA.Fill(DS, "MasterDocs")
    ...
    Private Sub LsTT_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LsTT.SelectedIndexChanged
        ...
        'ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where substring(Mas_IndNos,1," & count1 & ")='" & Trim(TxtIn.Text) & "' AND Mas_flag3='Yes' and Mas_Entry1='Ok'", CON)
        ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where Mas_IndNos='" & Trim(LsTT.SelectedValue) & "'", CON)
        DS = New DataSet
        ADA.Fill(DS, "MasterDocs")
    ...
    Private Sub LsNF_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LsNF.SelectedIndexChanged
        count1 = Len(Trim(TxtIn.Text))
        ss = Trim(TxtIn.Text)

        'ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where substring(Mas_IndNos,1," & count1 & ")='" & Trim(TxtIn.Text) & "' AND Mas_flag3='Yes' and Mas_Entry1='Ok'", CON)
        ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where Mas_IndNos='" & Trim(LsNF.SelectedValue) & "'", CON)
        DS = New DataSet
        ADA.Fill(DS, "MasterDocs")
