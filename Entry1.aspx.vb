...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            While DR.Read
                TT = Mid(DR.GetValue(0), 1, 5) + "-" + Mid(DR.GetValue(1), 1, 100)
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If TxtFlg1.Text = "Edit" Then
            ...
            ss = "UPDATE LoanIssue SET LiNo='" & Trim(LstRefno.SelectedValue) & "',LiDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LiBrCode= '" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "',LiCur= '" & Trim(Lstcncy1.SelectedValue) & "',LiLKR=" & Trim(TxtERate.Text) & ",LiAmt=" & Trim(TxtCrdAmt.Text) & ",LiIntRate=" & Trim(TxtIntRate.Text) & ",LiPeriod=" & Trim(TxtNodys.Text) & ",LiStatus='No',LiRemark='" & Trim(TxtMsg1.Text) & "',LiIntAmt=" & Trim(val1.Text) & ",LiIntDays=" & Trim(TxtNodys.Text) & ",LiIntPmt=" & Trim(val1.Text) & ",LiCaptpmt=" & Trim(TxtCrdAmt.Text) & ",LiActNo='-',LiChq='-',LiBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',LiLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LiDebTax=" & Trim(Val3.Text) & ",LiFndVal='" & Trim(TxtDtVal.Text) & "',Ent_Time1='" & FormatDateTime(TimeOfDay) & "',Ent_Date1='" & Format(DateValue(Today()), "MM/dd/yyyy") & "' WHERE LiNo='" & Trim(LstRefno.SelectedValue) & "'"
            ss = "UPDATE LoanIssue SET LiNo='" & Trim(LstRefno.SelectedValue) & "',LiDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LiBrCode= '" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "',LiCur= '" & Trim(Lstcncy1.SelectedValue) & "',LiLKR=" & Trim(TxtERate.Text) & ",LiAmt=" & Trim(TxtCrdAmt.Text) & ",LiIntRate=" & Trim(TxtIntRate.Text) & ",LiPeriod=" & Trim(TxtNodys.Text) & ",LiStatus='No',LiRemark='" & Trim(TxtMsg1.Text) & "',LiIntAmt=" & Trim(val1.Text) & ",LiIntDays=" & Trim(TxtNodys.Text) & ",LiIntPmt=" & Trim(val1.Text) & ",LiCaptpmt=" & Trim(TxtCrdAmt.Text) & ",LiActNo='-',LiChq='-',LiBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',LiLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LiDebTax=" & Trim(Val3.Text) & ",LiFndVal='" & Trim(TxtDtVal.Text) & "',Ent_Date1='" & Format(DateValue(Today()), "MM/dd/yyyy") & "' WHERE LiNo='" & Trim(LstRefno.SelectedValue) & "'"
        ...
        Else
            ...
            ss1 = "INSERT INTO LoanIssue (LiNo,LiDate,LiBrCode,LiCur,LiLKR,LiAmt,LiIntRate,LiPeriod,LiStatus,LiRemark,LiIntAmt,LiIntDays,LiIntPmt,LiCaptpmt,LiActNo,LiChq,LiBdate,liLeCode,LiDebTax,LiFndVal,Ent_code,Ent_Time,Ent_date,LiPrLNo) VALUES ('" & Trim(TxtRefno.Text) & "','" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "','" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "','" & Trim(Lstcncy1.SelectedValue) & "'," & Trim(TxtERate.Text) & "," & Trim(TxtCrdAmt.Text) & "," & Trim(TxtIntRate.Text) & "," & Trim(TxtNodys.Text) & ",'No','" & Trim(TxtMsg1.Text) & "'," & Trim(val1.Text) & "," & Trim(TxtNodys.Text) & "," & Trim(val1.Text) & "," & Trim(TxtCrdAmt.Text) & ",'-','-','" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "','" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "'," & Trim(Val3.Text) & "," & Trim(TxtDtVal.Text) & ",'" & Trim(l1.Text) & "','" & FormatDateTime(TimeOfDay) & "','" & Format(DateValue(Today()), "MM/dd/yyyy") & "','" & TxtPrLno.Text & "')"
        ...
        If TxtFlg1.Text = "Edit" Then
            Cmd.Connection = CON
            ss = "UPDATE LoanReceive SET LrNo='" & Trim(LstRefno.SelectedValue) & "',LrDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LrBrCode= '" & Trim(LblDbtInv.Text) & "',LrCur= '" & Trim(Lstcncy1.SelectedValue) & "',LrLKR=" & Trim(TxtERate.Text) & ",LrAmt=" & Trim(TxtCrdAmt.Text) & ",LrIntRate=" & Trim(TxtIntRate.Text) & ",LrPeriod=" & Trim(TxtNodys.Text) & ",LrStatus='No',LrRemark='" & Trim(TxtMsg2.Text) & "',LrIntAmt=" & Trim(val1.Text) & ",LrIntDays=" & Trim(TxtNodys.Text) & ",LrIntPmt=" & Trim(val1.Text) & ",LrCaptpmt=" & Trim(TxtCrdAmt.Text) & ",LrChq='-',LrBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',lrLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LrDebTax=" & Trim(Val3.Text) & ",LrFndVal=" & Trim(TxtDtVal.Text) & "' WHERE LrNo='" & Trim(LstRefno.SelectedValue) & "'"

            ss1 = Trim("D" + Mid(Trim(LstRefno.SelectedValue), 2, 5))


            If Trim(TxtDtVal.Text) = "" Then
                SS2 = 0
            End If

            ss = "UPDATE LoanReceive SET LrNo='" & Trim(ss1) & "',LrDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LrBrCode= '" & Trim(LblDbtInv.Text) & "',LrCur= '" & Trim(Lstcncy1.SelectedValue) & "',LrLKR='" & Trim(TxtERate.Text) & "',LrAmt='" & Trim(TxtCrdAmt.Text) & "',LrIntRate='" & Trim(TxtIntRate.Text) & "',LrPeriod='" & Trim(TxtNodys.Text) & "',LrStatus='No',LrRemark='" & Trim(TxtMsg2.Text) & "',LrIntAmt='" & Trim(val1.Text) & "',LrIntDays='" & Trim(TxtNodys.Text) & "',LrIntPmt='" & Trim(val1.Text) & "',LrCaptpmt='" & Trim(TxtCrdAmt.Text) & "',LrChq='-',LrBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',LrLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LrDebTax='" & Trim(Val3.Text) & "',LrFndVal='" & SS2 & "' WHERE LrNo='" & Trim(ss1) & "'"



            Cmd.CommandText = ("UPDATE LoanReceive SET LrNo='" & Trim(ss1) & "',LrDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LrBrCode= '" & Trim(LblDbtInv.Text) & "',LrCur= '" & Trim(Lstcncy1.SelectedValue) & "',LrLKR='" & Trim(TxtERate.Text) & "',LrAmt='" & Trim(TxtCrdAmt.Text) & "',LrIntRate='" & Trim(TxtIntRate.Text) & "',LrPeriod='" & Trim(TxtNodys.Text) & "',LrStatus='No',LrRemark='" & Trim(TxtMsg2.Text) & "',LrIntAmt='" & Trim(val1.Text) & "',LrIntDays='" & Trim(TxtNodys.Text) & "',LrIntPmt='" & Trim(val1.Text) & "',LrCaptpmt='" & Trim(TxtCrdAmt.Text) & "',LrChq='-',LrBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',LrLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LrDebTax='" & Trim(Val3.Text) & "',LrFndVal='" & SS2 & "' WHERE LrNo='" & Trim(ss1) & "'")
            Cmd.ExecuteNonQuery()

            Sinvno = LstRefno.SelectedValue
        Else
            ss = Format(Today(), "MM/dd/yyyy")
            ss1 = "INSERT INTO LoanReceive (LrNo,LrDate,LrBrCode,LrCur,LrLKR,LrAmt,LrIntRate,LrPeriod,LrStatus,LrRemark,LrIntAmt,LrIntDays,LrIntPmt,LrCaptpmt,LrChq,LrBdate,lrLeCode,LrDebTax,LrFndVal,LrPrLNo) VALUES ('" & Trim(LblDbtInv.Text) & "','" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "','" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "','" & Trim(Lstcncy1.SelectedValue) & "'," & Trim(TxtERate.Text) & "," & Trim(TxtCrdAmt.Text) & "," & Trim(TxtIntRate.Text) & "," & Trim(TxtNodys.Text) & ",'No','" & Trim(TxtMsg2.Text) & "'," & Trim(val1.Text) & "," & Trim(TxtNodys.Text) & "," & Trim(val1.Text) & "," & Trim(TxtCrdAmt.Text) & ",'-','" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "','" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "'," & Trim(Val3.Text) & "," & Trim(TxtDtVal.Text) & ",'" & TxtPrLno.Text & "')"
            ss1 = Trim("D" + Mid(Trim(TxtRefno.Text), 2, 9))
            Cmd.Connection = CON


            ss = "INSERT INTO LoanReceive (LrNo,LrDate,LrBrCode,LrCur,LrLKR,LrAmt,LrIntRate,LrPeriod,LrStatus,LrRemark,LrIntAmt,LrIntDays,LrIntPmt,LrCaptpmt,LrChq,LrBdate,lrLeCode,LrDebTax,LrFndVal,LrPrLNo) VALUES ('" & Trim(ss1) & "','" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "','" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "','" & Trim(Lstcncy1.SelectedValue) & "'," & Trim(TxtERate.Text) & "," & Trim(TxtCrdAmt.Text) & "," & Trim(TxtIntRate.Text) & "," & Trim(TxtNodys.Text) & ",'No','" & Trim(TxtMsg2.Text) & "'," & Trim(val1.Text) & "," & Trim(TxtNodys.Text) & "," & Trim(val1.Text) & "," & Trim(TxtCrdAmt.Text) & ",'-','" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "','" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "'," & Trim(Val3.Text) & "," & Trim(TxtDtVal.Text) & ",'" & TxtPrLno.Text & "')"
    ...
    Private Sub BtnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnEdit.Click
        ...
        ss = "SELECT liNo FROM LoanIssue where LiDate='" & Format(CDate(Today()), "MM/dd/yyyy") & "' and Ent_Code='" & Trim(l1.Text) & "' and LiStatus='No'"
        BtnAdd.Enabled = False
            ...
            For Each drt2 In DS.Tables("LoanIssue").Rows
                ...
                If Count2 <> 0 Then
                    For Each drt3 In DS1.Tables("Lender").Rows
                        LstLNam.SelectedValue = ss + "-" + Mid(drt3("LeName"), 1, 100)
                    Next
                End If
                ...
                If Count2 <> 0 Then
                    ...
                    For Each drt3 In DS1.Tables("Borrower").Rows
                        LstBName.SelectedValue = ss + "-" + Mid(drt3("BrName"), 1, 100)
                    Next
                End If
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        K = Len(Trim(LstBName.SelectedValue))
        'Trim(Mid(LstBName.SelectedValue, 1, K - 6))
        Global.pcat = Trim(Right(LstBName.SelectedValue, K - 6))

        Dim strReport As String = ""
        strReport = "LenderReport.aspx"
    ...
    Private Sub TxtPrLno_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtPrLno.TextChanged
        ...
        If count1 <> 0 Then
            ...
            For Each drt2 In DS.Tables("LoanIssue").Rows
                ...
                If Count2 <> 0 Then
                    For Each drt3 In DS1.Tables("Lender").Rows
                        LstLNam.SelectedValue = Mid(drt3("LeCode"), 1, 5) + "-" + Mid(drt3("LeName"), 1, 100)
                    Next
                End If
                ...
                If Count2 <> 0 Then
                    ...
                    For Each drt3 In DS1.Tables("Borrower").Rows
                        LstBName.SelectedValue = Mid(drt3("BrCode"), 1, 5) + "-" + Mid(drt3("BrName"), 1, 100)
                    Next
                End If
