...
#End Region
    ...
    Private Sub Data4()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand(ss, CON)
    ...
    Private Sub DataGrid1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemDataBound
        ...
        If e.Item.ItemType.ToString = "Item" Or e.Item.ItemType.ToString = "AlternatingItem" Then
            ...
            t5 = Trim(e.Item.Cells(4).Text)
            t6 = Trim(e.Item.Cells(5).Text)
            t7 = Trim(e.Item.Cells(6).Text)
    ...
    Private Sub BtnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnUpdate.Click
        ...
        For Each gridrow In DataGrid1.Items
            ...
            t6 = CType(gridrow.FindControl("Lnote"), TextBox).Text
            t7 = CType(gridrow.FindControl("Chqno"), TextBox).Text
            t8 = CType(gridrow.FindControl("Sdt"), TextBox).Text
            ...
            If count1 <> 0 Then
                ...
                Else
                    CMD.Connection = CON
                    ' SS = "UPDATE RelationMaster SET Emp_InsPayAmt=" & Trim(t8) & ",Emp_InsChqno='" & Trim(t7) & "',Emp_InsRecDt='" & Mid(Trim(t6), 4, 2) + "/" + Mid(Trim(t6), 1, 2) + "/" + Mid(Trim(t6), 7, 4) & "',Emp_RecFg='Y' where Emp_No=" & Val(Trim(t2)) & " and Emp_com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "' and Emp_InsFg='Y'"
    ...
    Private Sub LstCat_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Data4()
    End Sub
