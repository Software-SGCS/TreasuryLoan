<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PosEntrySBM.aspx.vb" Inherits="TreasuryLoan.PosEntrySBM" %>
...
<asp:panel id="Panel5" runat="server" Width="890px" Height="62px">Panel</asp:panel></asp:panel>
				...
				Height="11px" Width="120px" Visible="False">Credit Limit(Days)</asp:label>
			...
			<asp:button id="BtnEdit" style="Z-INDEX: 102; LEFT: 80px; POSITION: absolute; TOP: 584px" tabIndex="8"
				...
				runat="server" Width="256px" Visible="False"></asp:textbox><asp:textbox id="TxtComNam" style="Z-INDEX: 108; LEFT: 432px; POSITION: absolute; TOP: 88px"
				tabIndex="3" runat="server" Width="288px"></asp:textbox><asp:label id="Label9" style="Z-INDEX: 109; LEFT: 376px; POSITION: absolute; TOP: 208px" runat="server"
				Height="16px" Width="58px">E_mail</asp:label><asp:textbox id="TxtComPer" style="Z-INDEX: 110; LEFT: 168px; POSITION: absolute; TOP: 168px"
				tabIndex="10" runat="server" Width="248px"></asp:textbox><asp:textbox id="TxtComAdd" style="Z-INDEX: 111; LEFT: 168px; POSITION: absolute; TOP: 128px"
				runat="server" Width="392px"></asp:textbox><asp:textbox id="TxtComNo" style="Z-INDEX: 112; LEFT: 168px; POSITION: absolute; TOP: 88px" tabIndex="1"
				runat="server" Height="20px" Width="56px" AutoPostBack="True"></asp:textbox><asp:textbox id="Txtemail" style="Z-INDEX: 113; LEFT: 448px; POSITION: absolute; TOP: 208px"
				...
				Height="16px" Width="114px">Suppliers Name</asp:label><asp:label id="Invoice" style="Z-INDEX: 115; LEFT: 32px; POSITION: absolute; TOP: 88px" runat="server"
				Height="24px" Width="104px">Company Code</asp:label><asp:label id="Label11" style="Z-INDEX: 116; LEFT: 32px; POSITION: absolute; TOP: 168px" runat="server"
				Height="24px" Width="129px"> Contact Person</asp:label><asp:label id="Label10" style="Z-INDEX: 117; LEFT: 32px; POSITION: absolute; TOP: 136px" runat="server"
				Height="24px" Width="112px">Address</asp:label><asp:button id="Button1" style="Z-INDEX: 118; LEFT: 248px; POSITION: absolute; TOP: 88px" runat="server"
				Height="24px" Width="48px" Text="Search"></asp:button><asp:button id="BttIns1" style="Z-INDEX: 119; LEFT: 720px; POSITION: absolute; TOP: 248px" runat="server"
			...
			<DIV style="Z-INDEX: 120; LEFT: 16px; WIDTH: 944px; POSITION: absolute; TOP: -32px; HEIGHT: 71px"
				align="left" ms_positioning="FlowLayout"><FONT face="Tahoma"><FONT size="5"><FONT size="4"><asp:panel id="Panel2" runat="server" Height="40px" Width="952px" BackColor="Navy">Panel</asp:panel>&nbsp;New 
							Company&nbsp;</FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT></FONT></DIV>
			<asp:panel id="Panel6" style="Z-INDEX: 123; LEFT: 784px; POSITION: absolute; TOP: 56px" runat="server"
				Height="384px" Width="184px" BackColor="Navy" BackImageUrl="file:///C:\Inetpub\wwwroot\Insu\images\question1.jpg">l 
<asp:Panel id="Panel7" style="Z-INDEX: 101; LEFT: -912px; POSITION: absolute; TOP: -16px" runat="server"
				...
				runat="server" Width="176px"></asp:textbox><asp:textbox id="TxtCrd" style="Z-INDEX: 126; LEFT: 168px; POSITION: absolute; TOP: 248px" tabIndex="4"
				runat="server" Width="32px" Visible="False"></asp:textbox><asp:label id="Label1" style="Z-INDEX: 127; LEFT: 32px; POSITION: absolute; TOP: 208px" runat="server"
				Height="24px" Width="128px">Vat Registration No</asp:label><asp:label id="Label2" style="Z-INDEX: 128; LEFT: 376px; POSITION: absolute; TOP: 248px" runat="server"
				Height="16px" Width="58px" Visible="False">TelNos</asp:label></form>
	</body>
</HTML>
