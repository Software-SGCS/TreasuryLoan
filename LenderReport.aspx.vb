...
#End Region
    ...
    Private Sub BindTheGrid()
        ...
        ss = "Select [LoanIssue].Id as Id,[LoanIssue].LiNo as LiNo,CONVERT(VARCHAR(10),[LoanIssue].LiDate,103) as LiDate,[LoanIssue].LiCur as LiCur,convert(float,[LoanIssue].LiAmt,2) as LiAmt,convert(float,[LoanIssue].LiIntRate,2) as LiIntRate,convert(float,[LoanIssue].LiIntPmt,2) as LiIntPmt,convert(float,([LoanIssue].LiIntPmt+[LoanIssue].LicaptPmt+[LoanIssue].Lifndval+[LoanIssue].lidebtax),2) as TotAmt,convert(VARCHAR(10),[LoanIssue].LiBDate,103) as LiBDate,[Borrower].BrSName as BrName from LoanIssue ,Borrower where [LoanIssue].LIBrcode=[Borrower].BrCode and [LoanIssue].LiStatus='No' and [LoanIssue].LiLeCode ='" & Right(Global.pcat, 5) & "'"
    ...
    Private Sub Datagrid2_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles Datagrid2.ItemDataBound
        ...
        ElseIf e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            ss = e.Item.Cells(3).Text
            ss = e.Item.Cells(4).Text
            ss = e.Item.Cells(5).Text
