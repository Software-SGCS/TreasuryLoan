...
Public Class EntryA1
    ...
    Protected WithEvents BtnCreInv As System.Web.UI.WebControls.ImageButton
    Protected WithEvents BtnDbtInv As System.Web.UI.WebControls.ImageButton
    Protected WithEvents l1 As System.Web.UI.WebControls.Label
    Protected WithEvents TxtRNodys As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtRMsg2 As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            CMD = New SqlCommand("SELECT Lecode,LeName From Lender", CON)
    ...
    Private Sub BtnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAdd.Click
        ...
        CMD = New SqlCommand("SELECT liNo FROM LoanIssue where Ent_Code='" & Trim(l1.Text) & "' and LiStatus='No '", CON)
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If TxtFlg1.Text = "Add" Then
            Cmd.Connection = CON

            ss = "UPDATE LoanIssue SET LiNo='" & Trim(LstRefno.SelectedValue) & "',LiDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LiBrCode= '" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "',LiCur= '" & Trim(Lstcncy1.SelectedValue) & "',LiLKR=" & Trim(TxtERate.Text) & ",LiAmt=" & Trim(TxtCrdAmt.Text) & ",LiIntRate=" & Trim(TxtIntRate.Text) & ",LiPeriod=" & Trim(TxtNodys.Text) & ",LiStatus='No',LiRemark='" & Trim(TxtMsg1.Text) & "',LiIntAmt=" & Trim(val1.Text) & ",LiIntDays=" & Trim(TxtNodys.Text) & ",LiIntPmt=" & Trim(val1.Text) & ",LiCaptpmt=" & Trim(TxtCrdAmt.Text) & ",LiActNo='-',LiChq='-',LiBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',liLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LiDebTax=" & Trim(Val3.Text) & ",LiFndVal=" & Trim(TxtFndVal.Text) & ",Ent_Time1='" & FormatDateTime(TimeOfDay) & "',Ent_Date1='" & Format(DateValue(Today()), "MM/dd/yyyy") & "' WHERE LiNo='" & Trim(LstRefno.SelectedValue) & "'"
            'Cmd.CommandText = ("UPDATE LoanIssue SET LiNo='" & Trim(LstRefno.SelectedValue) & "',LiDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LiBrCode= '" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "',LiCur= '" & Trim(Lstcncy1.SelectedValue) & "',LiLKR=" & Trim(TxtERate.Text) & ",LiAmt=" & Trim(TxtCrdAmt.Text) & ",LiIntRate=" & Trim(TxtIntRate.Text) & ",LiPeriod=" & Trim(TxtNodys.Text) & ",LiStatus='No',LiRemark='" & Trim(TxtMsg1.Text) & "',LiIntAmt=" & Trim(val1.Text) & ",LiIntDays=" & Trim(TxtNodys.Text) & ",LiIntPmt=" & Trim(val1.Text) & ",LiCaptpmt=" & Trim(TxtCrdAmt.Text) & ",LiActNo='-',LiChq='-',LiBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',liLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LiDebTax=" & Trim(Val3.Text) & ",LiFndVal=" & Trim(TxtFndVal.Text) & ",Ent_Time1='" & FormatDateTime(TimeOfDay) & "',Ent_Date1='" & Format(DateValue(Today()), "MM/dd/yyyy") & "' WHERE LiNo='" & Trim(LstRefno.SelectedValue) & "'")
            'Cmd.CommandText = ("UPDATE LoanIssue SET LiPeriod=" & Trim(TxtNodys.Text) & " WHERE LiNo='" & Trim(LstRefno.SelectedValue) & "'")
            'VAL1 = Format(Val(TxtCrdAmt.Text), "###########.00")
            'VAL2 = Format(Val(TxtCrdAmt.Text), "###########.00")
            Cmd.CommandText = ("UPDATE LoanIssue SET LiNo='" & Trim(LstRefno.SelectedValue) & "',LiDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LiBrCode= '" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "',LiCur= '" & Trim(Lstcncy1.SelectedValue) & "',LiLKR=" & Trim(TxtERate.Text) & ",LiAmt=" & Trim(Format(Val(TxtCrdAmt.Text), "###########.00")) & ",LiIntRate=" & Trim(Format(Val(TxtIntRate.Text), "#########.00")) & ",LiPeriod=" & Trim(TxtNodys.Text) & ",LiStatus='No',LiRemark='" & Trim(TxtMsg1.Text) & "',LiIntAmt=" & Trim(Format(Val(val1.Text), "###########.00")) & ",LiIntDays=" & Trim(TxtNodys.Text) & ",LiIntPmt=" & Trim(Format(Val(val1.Text), "#########.00")) & ",LiCaptpmt=" & Trim(TxtCrdAmt.Text) & ",LiActNo='-',LiChq='-',LiBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',liLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LiDebTax=" & Trim(Val3.Text) & ",LiFndVal=" & Trim(TxtFndVal.Text) & ",Ent_Time1='" & FormatDateTime(TimeOfDay) & "',Ent_Date1='" & Format(DateValue(Today()), "MM/dd/yyyy") & "' WHERE LiNo='" & Trim(LstRefno.SelectedValue) & "'")
            ss = "UPDATE LoanIssue SET LiNo='" & Trim(LstRefno.SelectedValue) & "',LiDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LiBrCode= '" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "',LiCur= '" & Trim(Lstcncy1.SelectedValue) & "',LiLKR=" & Trim(TxtERate.Text) & ",LiAmt=" & Trim(Format(Val(TxtCrdAmt.Text), "###########.00")) & ",LiIntRate=" & Trim(Format(Val(TxtIntRate.Text), "#########.00")) & ",LiPeriod=" & Trim(TxtNodys.Text) & ",LiStatus='No',LiRemark='" & Trim(TxtMsg1.Text) & "',LiIntAmt=" & Trim(val1.Text) & ",LiIntDays=" & Trim(TxtNodys.Text) & ",LiIntPmt=" & Trim(Format(Val(val1.Text), "#########.00")) & ",LiCaptpmt=" & Trim(TxtCrdAmt.Text) & ",LiActNo='-',LiChq='-',LiBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',liLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LiDebTax=" & Trim(Val3.Text) & ",LiFndVal=" & Trim(TxtFndVal.Text) & ",Ent_Time1='" & FormatDateTime(TimeOfDay) & "',Ent_Date1='" & Format(DateValue(Today()), "MM/dd/yyyy") & "' WHERE LiNo='" & Trim(LstRefno.SelectedValue) & "'"

            'Cmd.CommandText = ("UPDATE LoanIssue SET LiNo='" & Trim(LstRefno.SelectedValue) & "',LiDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LiBrCode= '" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "',LiCur= '" & Trim(Lstcncy1.SelectedValue) & "',LiLKR=" & Trim(TxtERate.Text) & ",LiPeriod=" & Trim(TxtNodys.Text) & ",LiStatus='No',LiRemark='" & Trim(TxtMsg1.Text) & "',LiIntAmt=" & Trim(val1.Text) & ",LiIntDays=" & Trim(TxtNodys.Text) & ",LiIntPmt=" & Trim(val1.Text) & ",LiCaptpmt=" & Trim(TxtCrdAmt.Text) & ",LiActNo='-',LiChq='-',LiBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',liLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LiDebTax=" & Trim(Val3.Text) & ",LiFndVal=" & Trim(TxtFndVal.Text) & ",Ent_Time1='" & FormatDateTime(TimeOfDay) & "',Ent_Date1='" & Format(DateValue(Today()), "MM/dd/yyyy") & "' WHERE LiNo='" & Trim(LstRefno.SelectedValue) & "'")
            Cmd.ExecuteNonQuery()
            ...
            ADA = New SqlDataAdapter("SELECT * FROM LoanAmend", CON)

            DS = New DataSet
            ADA.Fill(DS, "LoanAmend")

            count1 = DS.Tables("LoanAmend").Rows.Count
            count1 = count1 + 1
            ss = Trim(TxtRefno.Text) + "A" + Trim(Str(count1))
            TxtAnO.Text = ss

            ss1 = "INSERT INTO LoanAmend (L_No,L_ADt,L_PNoDys,L_CNoDys,L_ANo,L_Amsg2,L_Msg2,) VALUES ('" & Trim(TxtRefno.Text) & "','" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "'," & Trim(TxtRNodys.Text) & "," & Trim(TxtNodys.Text) & ",'" & Trim(ss) & "','" & Trim(TxtRMsg2.Text) & "','" & Trim(TxtMsg2.Text) & "')"
            Cmd.CommandText = ("INSERT INTO LoanAmend (L_No,L_ADt,L_PNoDys,L_CNoDys,L_ANo,L_Amsg2,L_Msg2) VALUES ('" & Trim(TxtRefno.Text) & "','" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "'," & Trim(TxtRNodys.Text) & "," & Trim(TxtNodys.Text) & ",'" & Trim(ss) & "','" & Trim(TxtRMsg2.Text) & "','" & Trim(TxtMsg2.Text) & "')")
        ...
        Else
            ...
            Cmd.Connection = CON
            Cmd.CommandText = ("INSERT INTO LoanIssue (LiNo,LiDate,LiBrCode,LiCur,LiLKR,LiAmt,LiIntRate,LiPeriod,LiStatus,LiRemark,LiIntAmt,LiIntDays,LiIntPmt,LiCaptpmt,LiActNo,LiChq,LiBdate,liLeCode,LiDebTax,LiFndVal,Ent_code,Ent_Time,Ent_date) VALUES ('" & Trim(TxtRefno.Text) & "','" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "','" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "','" & Trim(Lstcncy1.SelectedValue) & "'," & Trim(TxtERate.Text) & "," & Trim(TxtCrdAmt.Text) & "," & Trim(TxtIntRate.Text) & "," & Trim(TxtNodys.Text) & ",'No','" & Trim(TxtMsg1.Text) & "'," & Trim(val1.Text) & "," & Trim(TxtNodys.Text) & "," & Trim(val1.Text) & "," & Trim(TxtCrdAmt.Text) & ",'-','-','" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "','" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "'," & Trim(Val3.Text) & "," & Trim(TxtFndVal.Text) & ",'" & Trim(l1.Text) & "','" & FormatDateTime(TimeOfDay) & "','" & Format(DateValue(Today()), "MM/dd/yyyy") & "')")
            Cmd.ExecuteNonQuery()
            Sinvno = TxtRefno.Text
        End If
        ...
        If TxtFlg1.Text = "Add" Then
            ...
            'Cmd.CommandText = ("UPDATE LoanReceive SET LrRemark='" & Trim(TxtMsg2.Text) & " WHERE LrNo='" & Trim(LstRefno.SelectedValue) & "'")

            Cmd.CommandText = ("UPDATE LoanReceive SET LrNo='" & Trim(LstRefno.SelectedValue) & "',LrDate='" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "',LrBrCode= '" & Trim(LblDbtInv.Text) & "',LrCur= '" & Trim(Lstcncy1.SelectedValue) & "',LrLKR=" & Trim(TxtERate.Text) & ",LrAmt=" & Trim(TxtCrdAmt.Text) & ",LrIntRate=" & Trim(TxtIntRate.Text) & ",LrPeriod=" & Trim(TxtNodys.Text) & ",LrStatus='No',LrRemark='" & Trim(TxtMsg2.Text) & "',LrIntAmt=" & Trim(val1.Text) & ",LrIntDays=" & Trim(TxtNodys.Text) & ",LrIntPmt=" & Trim(val1.Text) & ",LrCaptpmt=" & Trim(TxtCrdAmt.Text) & ",LrChq='-',LrBdate='" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "',lrLeCode='" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "',LrDebTax=" & Trim(Val3.Text) & ",LrFndVal=" & Trim(TxtFndVal.Text) & " WHERE LrNo='" & Trim(LstRefno.SelectedValue) & "'")
            Cmd.ExecuteNonQuery()
        ...
        Else
            ...
            Cmd.Connection = CON
            Cmd.CommandText = ("INSERT INTO LoanReceive (LrNo,LrDate,LrBrCode,LrCur,LrLKR,LrAmt,LrIntRate,LrPeriod,LrStatus,LrRemark,LrIntAmt,LrIntDays,LrIntPmt,LrCaptpmt,LrChq,LrBdate,lrLeCode,LrDebTax,LrFndVal) VALUES ('" & Trim(LblDbtInv.Text) & "','" & Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid(TxtCrdDt.Text, 1, 2) + "/" + Mid(TxtCrdDt.Text, 7, 4) & "','" & Mid(Trim(LstBName.SelectedValue), 1, 5) & "','" & Trim(Lstcncy1.SelectedValue) & "'," & Trim(TxtERate.Text) & "," & Trim(TxtCrdAmt.Text) & "," & Trim(TxtIntRate.Text) & "," & Trim(TxtNodys.Text) & ",'No','" & Trim(TxtMsg2.Text) & "'," & Trim(val1.Text) & "," & Trim(TxtNodys.Text) & "," & Trim(val1.Text) & "," & Trim(TxtCrdAmt.Text) & ",'-','" & Mid(Label35.Text, 4, 2) + "/" + Mid(Label35.Text, 1, 2) + "/" + Mid(Label35.Text, 7, 4) & "','" & Mid(Trim(LstLNam.SelectedValue), 1, 5) & "'," & Trim(Val3.Text) & "," & Trim(TxtFndVal.Text) & ")")
            Cmd.ExecuteNonQuery()
            Sinvno = TxtRefno.Text
    ...
    Private Sub LstBName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LstBName.SelectedIndexChanged
        ...
        TxtMsg1.Text = "We will settle your loan according to above settlement procedure." + " " + Trim(Mid(LstBName.SelectedValue, 7, 100))
        ss = DateAdd(DateInterval.Day, (Val(TxtNodys.Text) - 6), CDate(Mid(TxtCrdDt.Text, 4, 2) + "/" + Mid((TxtCrdDt.Text), 1, 2) + "/" + Mid((TxtCrdDt.Text), 7, 4)))
        ss = Format(CDate(ss), "dd/MM/yyyy")
    ...
    Public Sub BindTheGrid()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select LoanAmend.[L_No] as L_No,convert(varchar(10),LoanAmend.[L_ADt],103) as L_ADt,LoanAmend.[L_ANo] as L_ANo,LoanAmend.[L_PNoDys] as L_PNoDys ,LoanAmend.[L_CNoDys] as L_CNoDys from LoanAmend where LoanAmend.[L_No]='" & Trim(LstRefno.SelectedValue) & "'", CON)
    ...
    Private Overloads Sub BtnCreInv_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BtnCreInv.Click
        Dim DSS As CrdInvoiceA = New CrdInvoiceA
        ...
        DSS.SetParameterValue("Ano", "" & Trim(TxtAnO.Text) & "")
    ...
    Private Sub BtnDbtInv_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BtnDbtInv.Click
        Dim DSS1 As DbtInvoiceA1 = New DbtInvoiceA1
        ...
        DSS1.SetParameterValue("Ano", "" & Trim(TxtAnO.Text) & "")
