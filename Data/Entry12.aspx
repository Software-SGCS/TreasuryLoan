<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Entry12.aspx.vb" Inherits="TreasuryLoan.Entry12" %>
	...
	<body bgColor="#dcefe3" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:label id="Label1" style="Z-INDEX: 100; LEFT: 32px; POSITION: absolute; TOP: 72px" runat="server"
				...
				Height="24px" Width="104px">Recieved Date</asp:label><asp:textbox id="TxtAppDate" style="Z-INDEX: 138; LEFT: 224px; POSITION: absolute; TOP: 344px"
				...
				Height="24px" Width="96px" BackColor="Silver">B/D</asp:label><asp:textbox id="txtCncy" style="Z-INDEX: 135; LEFT: 440px; POSITION: absolute; TOP: 296px" runat="server"
			...
			<asp:textbox id="TxtRecDt" style="Z-INDEX: 120; LEFT: 136px; POSITION: absolute; TOP: 136px"
				...
				Height="24px" Width="96px">B/D No</asp:label><asp:textbox id="TxtttNo" style="Z-INDEX: 157; LEFT: 136px; POSITION: absolute; TOP: 368px" runat="server"
