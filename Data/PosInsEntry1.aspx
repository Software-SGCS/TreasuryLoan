	...
	<body bgColor="#f0f8ff" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:panel id="Panel2" style="Z-INDEX: 106; LEFT: 24px; POSITION: absolute; TOP: -8px" runat="server"
				...
				Height="11px" Width="944px" BackColor="Navy"></asp:panel>
			<DIV style="Z-INDEX: 107; LEFT: 16px; WIDTH: 944px; POSITION: absolute; TOP: 16px; HEIGHT: 24px"
				align="left" ms_positioning="FlowLayout"><FONT face="Tahoma"><FONT size="5"><FONT size="4">&nbsp;Monthly 
							Settelement</FONT></FONT></FONT></DIV>
			<div id="Layer1" style="Z-INDEX: 101; LEFT: 24px; OVERFLOW: scroll; WIDTH: 856px; POSITION: relative; TOP: 56px; HEIGHT: 400px"><asp:datagrid id="DataGrid1" runat="server" Height="12px" Width="840px" BackColor="White" Font-Size="Small"
