	...
	<body bgColor="#ffffff" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:label id="Label1" style="Z-INDEX: 101; LEFT: 56px; POSITION: absolute; TOP: 72px" runat="server"
				...
				runat="server" Font-Names="Calibri" Width="88px" Height="24px" Font-Size="X-Small" BackColor="#FFFF80"></asp:textbox><asp:button id="BtnAdd" style="Z-INDEX: 111; LEFT: 32px; POSITION: absolute; TOP: 568px" runat="server"
				...
				runat="server" Font-Names="Calibri" Width="296px" Height="24px" Font-Size="X-Small" AutoPostBack="True" BackColor="#FFFF80"></asp:dropdownlist><asp:dropdownlist id="Lstcncy1" style="Z-INDEX: 116; LEFT: 736px; POSITION: absolute; TOP: 72px" tabIndex="4"
				...
				runat="server" Font-Names="Calibri" Width="294px" Height="102px" Font-Size="X-Small" TextMode="MultiLine" BackColor="#FFFF80"></asp:textbox><asp:dropdownlist id="LstMsg1" style="Z-INDEX: 126; LEFT: 560px; POSITION: absolute; TOP: 112px" runat="server"
				...
				runat="server" Font-Names="Calibri" Width="298px" Height="102px" Font-Size="X-Small" TextMode="MultiLine" BackColor="#FFFF80"></asp:textbox><asp:textbox id="TxtERate" style="Z-INDEX: 129; LEFT: 736px; POSITION: absolute; TOP: 96px" tabIndex="5"
				...
				tabIndex="3" runat="server" Font-Names="Calibri" Width="96px" Font-Size="X-Small" AutoPostBack="True" BackColor="#FFFF80"></asp:textbox><asp:textbox id="TxtNodys" style="Z-INDEX: 131; LEFT: 472px; POSITION: absolute; TOP: 96px" tabIndex="7"
				runat="server" Font-Names="Calibri" Width="49px" Font-Size="X-Small" AutoPostBack="True" BackColor="#FFFF80"></asp:textbox><asp:label id="Label20" style="Z-INDEX: 132; LEFT: 480px; POSITION: absolute; TOP: 280px" runat="server"
				...
				tabIndex="8" runat="server" Font-Names="Calibri" Width="49px" Font-Size="X-Small" AutoPostBack="True" BackColor="#FFFF80"></asp:textbox><asp:label id="LblDbtInv" style="Z-INDEX: 146; LEFT: 640px; POSITION: absolute; TOP: 224px"
				...
				tabIndex="12" runat="server" Font-Names="Calibri" Width="298px" Height="24px" Font-Size="X-Small" AutoPostBack="True" BackColor="#FFFF80"></asp:dropdownlist><asp:label id="LblCncy" style="Z-INDEX: 150; LEFT: 480px; POSITION: absolute; TOP: 256px" runat="server"
				...
				tabIndex="5" runat="server" Font-Names="Calibri" Width="96px" Height="24px" Font-Size="X-Small" AutoPostBack="True" BackColor="#FFFF80"></asp:textbox><asp:label id="LblDVal" style="Z-INDEX: 167; LEFT: 528px; POSITION: absolute; TOP: 192px" runat="server"
				...
				tabIndex="6" runat="server" Font-Names="Calibri" Width="96px" Height="24px" Font-Size="X-Small" AutoPostBack="True" BackColor="#FFFF80"></asp:textbox><asp:textbox id="TxtPrLno" style="Z-INDEX: 184; LEFT: 472px; POSITION: absolute; TOP: 72px" tabIndex="20"
				runat="server" Width="80px" Font-Size="X-Small" BackColor="#FFFF80"></asp:textbox><asp:label id="Label38" style="Z-INDEX: 185; LEFT: 336px; POSITION: absolute; TOP: 72px" runat="server"
