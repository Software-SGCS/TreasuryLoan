...
<asp:panel id="Panel5" runat="server" Height="62px" Width="890px">Panel</asp:panel></asp:panel>
			...
			<DIV id="Layer1" style="Z-INDEX: 101; LEFT: 24px; OVERFLOW: scroll; WIDTH: 728px; POSITION: absolute; TOP: 280px; HEIGHT: 166px"><asp:datagrid id="MyDataGrid" runat="server" BackColor="White" Width="760px" Height="120px" BorderColor="#E7E7FF"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="LeCode" HeaderText="Code">
			...
			<asp:button id="BtnEdit" style="Z-INDEX: 102; LEFT: 80px; POSITION: absolute; TOP: 584px" tabIndex="8"
				...
				runat="server" Width="390px" Visible="False" MaxLength="30"></asp:textbox><asp:textbox id="TxtComNam" style="Z-INDEX: 108; LEFT: 368px; POSITION: absolute; TOP: 64px"
				...
				Width="88px" Height="16px">Lender Name</asp:label><asp:label id="Invoice" style="Z-INDEX: 115; LEFT: 32px; POSITION: absolute; TOP: 64px" runat="server"
				Width="104px" Height="24px">Lender Code</asp:label><asp:label id="Label11" style="Z-INDEX: 116; LEFT: 32px; POSITION: absolute; TOP: 168px" runat="server"
			...
			<DIV style="Z-INDEX: 121; LEFT: 16px; WIDTH: 944px; POSITION: absolute; TOP: -32px; HEIGHT: 71px"
				align="left" ms_positioning="FlowLayout"><FONT face="Tahoma"><FONT size="5"><FONT size="4"><asp:panel id="Panel2" runat="server" BackColor="Navy" Width="952px" Height="40px">Panel</asp:panel>&nbsp;LENDER</FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT></FONT></DIV>
