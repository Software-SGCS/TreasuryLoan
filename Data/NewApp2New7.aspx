...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="NewApp2New7.aspx.vb" Inherits="TreasuryLoan.NewApp2New7" %>
	...
	<body MS_POSITIONING="GridLayout">
		<FORM id="Form1" method="post" runat="server">
			...
			<DIV style="Z-INDEX: 110; LEFT: 0px; WIDTH: 970px; POSITION: absolute; TOP: 24px; HEIGHT: 24px"
				align="left" ms_positioning="FlowLayout"><FONT face="Tahoma"><FONT size="5"><FONT size="4">Credit 
