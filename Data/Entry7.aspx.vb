...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            CMD = New SqlCommand("SELECT Mas_Refno FROM MasterDocs Where Mas_flag2='Yes' and Mas_Entry1='Ok'", CON)
            ...
            If count1 <> 0 Then
                ...
                For Each drt2 In DS.Tables("MasterDocs").Rows
                    ...
                    ADA1 = New SqlDataAdapter("SELECT * FROM licmas Where Mas_refno='" & Trim(LsRefno.SelectedValue) & "'", CON)

                    DS = New DataSet
                    ADA1.Fill(DS, "licmas")

                    count1 = DS.Tables("licmas").Rows.Count

                    If count1 <> 0 Then

                        For Each drt3 In DS.Tables("licMas").Rows
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Dim Cmd As New SqlCommand("SELECT * FROM licMas", CON)
        Cmd.ExecuteNonQuery()

        ADA = New SqlDataAdapter("SELECT * FROM licMas Where Mas_RefNo='" & Trim(TxtRefno.Text) & "'", CON)
        DS = New DataSet
        ADA.Fill(DS, "licMas")
        ...
        If count1 <> 0 Then
            ...
            ss = "UPDATE licMas SET Mas_des='" & Trim(Txtdes1.Text) & "',Mas_Appdt='" & Format(CDate(Trim(TxtAppDate.Text)), "MM/dd/yyyy") & "',Mas_Recdt='" & Format(CDate(Trim(TxtRecDate.Text)), "MM/dd/yyyy") & "' WHERE Mas_Refno='" & Trim(TxtRefno.Text) & "'"
            Cmd.CommandText = ("UPDATE licMas SET Mas_des='" & Trim(Txtdes1.Text) & "',Mas_Appdt='" & Mid(Trim(TxtAppDate.Text), 4, 2) + "/" + Mid(Trim(TxtAppDate.Text), 1, 2) + "/" + Mid(Trim(TxtAppDate.Text), 7, 4) & "',Mas_Recdt='" & Mid(Trim(TxtRecDate.Text), 4, 2) + "/" + Mid(Trim(TxtRecDate.Text), 1, 2) + "/" + Mid(Trim(TxtRecDate.Text), 7, 4) & "' WHERE Mas_Refno='" & Trim(TxtRefno.Text) & "'")
            Cmd.ExecuteNonQuery()
        Else
            ss = "INSERT INTO licMas(Mas_Refno,Mas_des,Mas_Appdt,Mas_Recdt) VALUES ('" & Trim(TxtRefno.Text) & "','" & Trim(Txtdes1.Text) & "','" & Mid(Trim(TxtAppDate.Text), 4, 2) + "/" + Mid(Trim(TxtAppDate.Text), 1, 2) + "/" + Mid(Trim(TxtAppDate.Text), 7, 4) & "','" & Mid(Trim(TxtRecDate.Text), 4, 2) + "/" + Mid(Trim(TxtRecDate.Text), 1, 2) + "/" + Mid(Trim(TxtRecDate.Text), 7, 4) & "')"
            Cmd.CommandText = ("INSERT INTO licMas(Mas_Refno,Mas_des,Mas_AppDt,Mas_RecDt) VALUES ('" & Trim(TxtRefno.Text) & "','" & Trim(Txtdes1.Text) & "','" & Mid(Trim(TxtAppDate.Text), 4, 2) + "/" + Mid(Trim(TxtAppDate.Text), 1, 2) + "/" + Mid(Trim(TxtAppDate.Text), 7, 4) & "','" & Mid(Trim(TxtRecDate.Text), 4, 2) + "/" + Mid(Trim(TxtRecDate.Text), 1, 2) + "/" + Mid(Trim(TxtRecDate.Text), 7, 4) & "')")
            Cmd.ExecuteNonQuery()
            ss = Format(Today(), "MM/dd/yyyy")
            Cmd.CommandText = ("UPDATE MasterDocs SET Mas_Entry4='Ok',Mas_Entry4Dt='" & ss & "' WHERE Mas_Refno='" & Trim(TxtRefno.Text) & "'")
            Cmd.ExecuteNonQuery()
    ...
    Private Sub ImageButton2_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton2.Click
        ...
        ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where substring(Mas_IndNos,1," & count1 & ")='" & Trim(TxtIn.Text) & "' AND Mas_flag2='Yes' and Mas_Entry1='Ok'", CON)
        DS = New DataSet
        ADA.Fill(DS, "MasterDocs")
        BtnSave.Enabled = True
        count1 = DS.Tables("MasterDocs").Rows.Count
        ...
        If count1 <> 0 Then
            ...
            For Each drt2 In DS.Tables("MasterDocs").Rows
                ...
                ADA1 = New SqlDataAdapter("SELECT * FROM licmas Where Mas_refno='" & Trim(TxtRefno.Text) & "'", CON)
