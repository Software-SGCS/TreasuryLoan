...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            CMD = New SqlCommand("SELECT Mas_Refno FROM MasterDocs Where Mas_flag1='Yes' and Mas_Entry1='Ok'", CON)
            ...
            If count1 <> 0 Then
                ...
                For Each drt2 In DS.Tables("MasterDocs").Rows
                    ...
                    ADA1 = New SqlDataAdapter("SELECT * FROM Insmas Where Mas_refno='" & Trim(LsRefno.SelectedValue) & "'", CON)
    ...
    Private Sub ImageButton2_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton2.Click
        ...
        ADA = New SqlDataAdapter("SELECT * FROM MasterDocs Where substring(Mas_IndNos,1," & count1 & ")='" & Trim(TxtIn.Text) & "' Mas_flag1='Yes' and Mas_Entry1='Ok'", CON)
        DS = New DataSet
        ADA.Fill(DS, "MasterDocs")
        BtnSave.Enabled = True
        count1 = DS.Tables("MasterDocs").Rows.Count
