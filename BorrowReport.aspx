	...
	<body bgColor="#f0f8ff" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:panel id="Panel4" style="Z-INDEX: 105; LEFT: 0px; POSITION: absolute; TOP: 536px" runat="server"
				...
				Width="97px" Height="24px">Borrower</asp:label><asp:dropdownlist id="LstBorrower" style="Z-INDEX: 107; LEFT: 144px; POSITION: absolute; TOP: 72px"
				...
				Width="160px" Height="24px"></asp:label></form>
	</body>
</HTML>
