...
#End Region
    ...
    Private Sub BindTheGrid()
        ...
        ss = "Select [LoanIssue].Id as Id,('D'+substring([LoanIssue].LiNo,2,5)) as LiNo,CONVERT(VARCHAR(10),[LoanIssue].LiDate,103) as LiDate,[LoanIssue].LiCur as LiCur,convert(float,[LoanIssue].LiAmt,2) as LiAmt,convert(float,[LoanIssue].LiIntRate,2) as LiIntRate,convert(float,[LoanIssue].LiIntPmt,2) as LiIntPmt,convert(float,([LoanIssue].LiIntPmt+[LoanIssue].LicaptPmt+[LoanIssue].Lifndval+[LoanIssue].lidebtax),2) as TotAmt,convert(VARCHAR(10),[LoanIssue].LiBDate,103) as LiBDate,[Lender].Lesname as BrName from LoanIssue ,Lender where [LoanIssue].LILecode=[Lender].LeCode and [LoanIssue].LiStatus='No' and [LoanIssue].LiBrCode ='" & Trim(Mid(LstBorrower.SelectedValue, 1, 5)) & "'"
    ...
    Private Sub Datagrid2_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles Datagrid2.ItemDataBound
        ...
        ElseIf e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            e.Item.Cells(1).Attributes.Add("onclick", "javascript:window.open('NewApp2New8.aspx?TYPE=" & Trim(e.Item.Cells(10).Text) & "')")
