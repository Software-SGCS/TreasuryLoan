<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PosEntryCus1.aspx.vb" Inherits="TreasuryLoan.PosEntryCus1" %>
...
<asp:panel id="Panel5" runat="server" Width="890px" Height="62px">Panel</asp:panel></asp:panel>
			...
			<DIV id="Layer1" style="Z-INDEX: 101; LEFT: 24px; OVERFLOW: scroll; WIDTH: 728px; POSITION: absolute; TOP: 280px; HEIGHT: 166px"><asp:datagrid id="MyDataGrid" runat="server" Height="120px" Width="760px" BackColor="White" cellpadding="3"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="BrCode" HeaderText="Bro Code">
			...
			<asp:button id="BtnEdit" style="Z-INDEX: 102; LEFT: 80px; POSITION: absolute; TOP: 584px" tabIndex="8"
				...
				Height="16px" Width="114px">Borrower Name</asp:label><asp:label id="Invoice" style="Z-INDEX: 115; LEFT: 32px; POSITION: absolute; TOP: 88px" runat="server"
				Height="24px" Width="104px">Borrower Code</asp:label><asp:label id="Label11" style="Z-INDEX: 116; LEFT: 32px; POSITION: absolute; TOP: 208px" runat="server"
...
<asp:Panel id="Panel7" style="Z-INDEX: 101; LEFT: -912px; POSITION: absolute; TOP: -16px" runat="server"
				...
				Height="24px" Width="128px">Borrower Short Name</asp:label><asp:label id="Label2" style="Z-INDEX: 127; LEFT: 376px; POSITION: absolute; TOP: 248px" runat="server"
