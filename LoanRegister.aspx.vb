...
Public Class LoanRegister
    ...
    Protected WithEvents LstLender As System.Web.UI.WebControls.DropDownList
...
#End Region
    ...
    Private Sub BindTheGrid()
        ...
        'ss = "Select [LoanIssue].Id as Id,[LoanIssue].LiNo as LiNo,CONVERT(VARCHAR(10),[LoanIssue].LiDate,103) as LiDate,[LoanIssue].LiCur as LiCur,convert(float,[LoanIssue].LiAmt,2) as LiAmt,convert(float,[LoanIssue].LiIntRate,2) as LiIntRate,convert(float,[LoanIssue].LiIntPmt,2) as LiIntPmt,convert(float,([LoanIssue].LiIntPmt+[LoanIssue].LicaptPmt+[LoanIssue].Lifndval+[LoanIssue].lidebtax),2) as TotAmt,convert(VARCHAR(10),[LoanIssue].LiBDate,103) as LiBDate,[Borrower].BrSName as BrName from LoanIssue ,Borrower Order by [LoanIssue].LiNo"
        ss = "Select * from view2"

        ss = "Select ID, Leno1,LiPrLno,LeSName,BrSName,CONVERT(VARCHAR(10),LrDate,103) as LrDate,CONVERT(VARCHAR(10),LrbDate,103) as LrbDate, Lrcur,LrAmt,TotAmt,LrIntPmt,LiChqNo,LiDeBank,LiNote,SETFG,SETFLG from view2"
    ...
    Private Sub Datagrid2_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles Datagrid2.ItemDataBound
        ...
        ElseIf e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            ss = e.Item.Cells(6).Text
            ss = e.Item.Cells(7).Text
            ss = e.Item.Cells(8).Text
            ss = e.Item.Cells(9).Text
            ss = e.Item.Cells(10).Text
            ss = e.Item.Cells(11).Text

            ss = e.Item.Cells(12).Text
            ss = e.Item.Cells(13).Text
            ss = e.Item.Cells(14).Text
            ss = e.Item.Cells(15).Text
            ss1 = e.Item.Cells(16).Text
            ss = e.Item.Cells(17).Text
            If Trim(ss) = "Y" Then
                e.Item.Cells(1).BackColor = Color.YellowGreen
                e.Item.Cells(2).BackColor = Color.YellowGreen
                e.Item.Cells(3).BackColor = Color.YellowGreen
                e.Item.Cells(4).BackColor = Color.YellowGreen
                e.Item.Cells(5).BackColor = Color.YellowGreen

                e.Item.Cells(6).BackColor = Color.YellowGreen
                e.Item.Cells(7).BackColor = Color.YellowGreen
                e.Item.Cells(8).BackColor = Color.YellowGreen
                e.Item.Cells(9).BackColor = Color.YellowGreen
                e.Item.Cells(10).BackColor = Color.YellowGreen
                e.Item.Cells(11).BackColor = Color.YellowGreen
                e.Item.Cells(12).BackColor = Color.YellowGreen
                e.Item.Cells(13).BackColor = Color.YellowGreen
                e.Item.Cells(14).BackColor = Color.YellowGreen
                e.Item.Cells(15).BackColor = Color.YellowGreen
            Else
                ...
                If Trim(ss1) = "Y" Then
                    ...
                    'e.Item.Cells(8).BackColor = Color.Yellow
                    'e.Item.Cells(9).BackColor = Color.Yellow
                    'e.Item.Cells(10).BackColor = Color.Yellow
                    'e.Item.Cells(11).BackColor = Color.Yellow
                    'e.Item.Cells(12).BackColor = Color.Yellow
                    'e.Item.Cells(13).BackColor = Color.Yellow
                    'e.Item.Cells(14).BackColor = Color.Yellow
                    'e.Item.Cells(15).BackColor = Color.Yellow


                Else

                    e.Item.Cells(1).BackColor = Color.Pink
                    e.Item.Cells(2).BackColor = Color.Pink
                    e.Item.Cells(3).BackColor = Color.Pink
                    e.Item.Cells(4).BackColor = Color.Pink
                    e.Item.Cells(5).BackColor = Color.Pink
                    e.Item.Cells(6).BackColor = Color.Pink
                    e.Item.Cells(7).BackColor = Color.Pink
                    e.Item.Cells(8).BackColor = Color.Pink
                    e.Item.Cells(9).BackColor = Color.Pink
                    e.Item.Cells(10).BackColor = Color.Pink
                    e.Item.Cells(11).BackColor = Color.Pink
                    e.Item.Cells(12).BackColor = Color.Pink
                    e.Item.Cells(13).BackColor = Color.Pink
                    e.Item.Cells(14).BackColor = Color.Pink
                    e.Item.Cells(15).BackColor = Color.Pink

                End If

            End If
            e.Item.Cells(1).Attributes.Add("onmouseover", "this.style.cursor='hand'")
            e.Item.Cells(1).Attributes.Add("onclick", "javascript:window.open('NewApp2New7.aspx?TYPE=" & Trim(e.Item.Cells(10).Text) & "')")

            'e.Item.Cells(2).Attributes.Add("onmouseover", "this.style.cursor='hand'")
            'e.Item.Cells(2).Attributes.Add("onclick", "javascript:window.open('NewApp2New0.aspx?TYPE=" & Trim(e.Item.Cells(7).Text) & "')")
    ...
    Private Sub ImageButton3_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton3.Click
        ...
        ss = Mid(Trim(LstLender.SelectedValue), 1, 5)
        ...
        DSS.SetParameterValue("Lender1", "" & ss & "")
        ...
        Response.ContentType = "Report1/pdf"
    ...
    Private Sub LstLender_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LstLender.SelectedIndexChanged
        BindTheGrid()
    End Sub
