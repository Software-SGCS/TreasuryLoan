...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            CMD = New SqlCommand("SELECT Mas_Refno FROM MasterDocs Where Mas_flag3='Yes' and Mas_Entry1='Ok'", CON)
            ...
            If count1 <> 0 Then
                ...
                For Each drt2 In DS.Tables("MasterDocs").Rows
                    ...
                    ADA1 = New SqlDataAdapter("SELECT * FROM Appmas Where Mas_refno='" & Trim(LsRefno.SelectedValue) & "'", CON)

                    DS = New DataSet
                    ADA1.Fill(DS, "Appmas")

                    count1 = DS.Tables("Appmas").Rows.Count

                    If count1 <> 0 Then

                        For Each drt3 In DS.Tables("AppMas").Rows
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Dim Cmd As New SqlCommand("SELECT * FROM AppMas", CON)
        Cmd.ExecuteNonQuery()

        ADA = New SqlDataAdapter("SELECT * FROM AppMas Where Mas_RefNo='" & Trim(TxtRefno.Text) & "'", CON)
        DS = New DataSet
        ADA.Fill(DS, "AppMas")
        ...
        If count1 <> 0 Then
            ...
            ss = "UPDATE AppMas SET Mas_des='" & Trim(Txtdes1.Text) & "',Mas_Appdt='" & Format(CDate(Trim(TxtAppDate.Text)), "MM/dd/yyyy") & "',Mas_Recdt='" & Format(CDate(Trim(TxtRecDate.Text)), "MM/dd/yyyy") & "' WHERE Mas_Refno='" & Trim(TxtRefno.Text) & "'"
            Cmd.CommandText = ("UPDATE AppMas SET Mas_des='" & Trim(Txtdes1.Text) & "',Mas_Appdt='" & Mid(Trim(TxtAppDate.Text), 4, 2) + "/" + Mid(Trim(TxtAppDate.Text), 1, 2) + "/" + Mid(Trim(TxtAppDate.Text), 7, 4) & "',Mas_Recdt='" & Mid(Trim(TxtRecDate.Text), 4, 2) + "/" + Mid(Trim(TxtRecDate.Text), 1, 2) + "/" + Mid(Trim(TxtRecDate.Text), 7, 4) & "' WHERE Mas_Refno='" & Trim(TxtRefno.Text) & "'")
            Cmd.ExecuteNonQuery()
        Else
            ss = "INSERT INTO AppMas(Mas_Refno,Mas_des,Mas_Appdt,Mas_Recdt) VALUES ('" & Trim(TxtRefno.Text) & "','" & Trim(Txtdes1.Text) & "','" & Mid(Trim(TxtAppDate.Text), 4, 2) + "/" + Mid(Trim(TxtAppDate.Text), 1, 2) + "/" + Mid(Trim(TxtAppDate.Text), 7, 4) & "','" & Mid(Trim(TxtRecDate.Text), 4, 2) + "/" + Mid(Trim(TxtRecDate.Text), 1, 2) + "/" + Mid(Trim(TxtRecDate.Text), 7, 4) & "')"
            Cmd.CommandText = ("INSERT INTO AppMas(Mas_Refno,Mas_des,Mas_AppDt,Mas_RecDt) VALUES ('" & Trim(TxtRefno.Text) & "','" & Trim(Txtdes1.Text) & "','" & Mid(Trim(TxtAppDate.Text), 4, 2) + "/" + Mid(Trim(TxtAppDate.Text), 1, 2) + "/" + Mid(Trim(TxtAppDate.Text), 7, 4) & "','" & Mid(Trim(TxtRecDate.Text), 4, 2) + "/" + Mid(Trim(TxtRecDate.Text), 1, 2) + "/" + Mid(Trim(TxtRecDate.Text), 7, 4) & "')")
            Cmd.ExecuteNonQuery()
            ss = Format(Today(), "MM/dd/yyyy")
            Cmd.CommandText = ("UPDATE MasterDocs SET Mas_Entry5='Ok',Mas_Entry5Dt='" & ss & "' WHERE Mas_Refno='" & Trim(TxtRefno.Text) & "'")
            Cmd.ExecuteNonQuery()
    ...
    Private Sub ImageButton2_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton2.Click
        ...
        If count1 <> 0 Then
            ...
            For Each drt2 In DS.Tables("MasterDocs").Rows
                ...
                ADA1 = New SqlDataAdapter("SELECT * FROM Appmas Where Mas_refno='" & Trim(TxtRefno.Text) & "'", CON)
