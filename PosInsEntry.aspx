		...
		<form id="Form1" method="post" runat="server">
			<asp:panel id="Panel2" style="Z-INDEX: 106; LEFT: 24px; POSITION: absolute; TOP: -8px" runat="server"
				...
				<asp:label id="Label3" style="Z-INDEX: 101; LEFT: 56px; POSITION: absolute; TOP: 80px" runat="server"
					Height="24px" Width="104px" BackColor="Lavender" Visible="False" Font-Bold="True">Company</asp:label>
			...
			<DIV id="Layer1" style="Z-INDEX: 101; LEFT: 18px; OVERFLOW: scroll; WIDTH: 852px; POSITION: relative; TOP: 48px; HEIGHT: 396px">
