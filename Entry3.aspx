<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Entry3.aspx.vb" Inherits="TreasuryLoan.Entry3" %>
	...
	<body MS_POSITIONING="GridLayout" bgColor="inactivecaptiontext">
		<form id="Form1" method="post" runat="server">
			<asp:label id="Label1" style="Z-INDEX: 101; LEFT: 192px; POSITION: absolute; TOP: 80px" runat="server"
				...
				Width="96px" Height="24px" BackColor="Silver">Insurance</asp:label><asp:textbox id="txtCncy" style="Z-INDEX: 138; LEFT: 504px; POSITION: absolute; TOP: 296px" runat="server"
