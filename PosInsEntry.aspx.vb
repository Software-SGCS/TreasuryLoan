...
#End Region
    ...
    Private Sub BtnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnUpdate.Click
        ...
        For Each gridrow In DataGrid1.Items
            ...
            ADA = New SqlDataAdapter("SELECT * FROM LoanIssue WHERE Lino='" & (Trim(t2)) & "'", CON)
            DS = New DataSet
            ...
            If count1 <> 0 Then
                ...
                Else
                    ...
                    SS = Format(CDate(Today()), "MM/dd/yyyy")
                    ''t='" & Mid(Trim(t6), 4, 2) + "/" + Mid(Trim(t6), 1, 2) + "/" + Mid(Trim(t6), 7, 4) & "',Emp_RecFg='Y' where Emp_No=" & Val(Trim(t2)) & " and Emp_com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "' and Emp_InsFg='Y'"
                    ss1 = "UPDATE LoanIssue SET linChqNo=" & Trim(t7) & ",LiDeBank='" & Trim(t6) & "',LiNote='" & Trim(t8) & "',Setfg='Y',SetDT='" & Trim(SS) & "' where Lino='" & Trim(t2) & "' and setfg='N'"
                    CMD.CommandText = ("UPDATE LoanIssue SET liChqNo='" & Trim(t7) & "',LiDeBank='" & Trim(t6) & "',LiNote='" & Trim(t8) & "',Setfg='Y',SetDT='" & Trim(SS) & "' where Lino='" & Trim(t2) & "' and setfg='N'")
